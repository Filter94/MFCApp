...
MFCApplication2Doc.h, MFCApplication2Doc.cpp — документ
    ...
    Документ будет содержать следующие строки:
        Расширение файла:      game
        Идентификатор типа файла:        MFCApplication2.Document
        Заголовок главного фрейма:  MFCApplication2
        Имя типа документа:       MFCApplication2
        Имя фильтра:         MFCApplication2 Files (*.game)
        Новое краткое имя файла: MFCApplication2
        Полное имя типа файла: MFCApplication2.Document
